...
if [[ ${PV} == "9999" ]] ; then
	inherit git-r3
	EGIT_REPO_URI="git@github.com:cmus/cmus https://github.com/cmus/cmus.git"
else
...
LICENSE="GPL-2"
SLOT="0"
IUSE="aac alsa ao coreaudio cue cdio cddb discid debug examples +flac jack
	libsamplerate +mad mikmod modplug mp4 musepack opus oss pidgin pulseaudio
	tremor +unicode +vorbis wavpack wma"
...
src_configure() {
	...
	my_config coreaudio CONFIG_COREAUDIO
